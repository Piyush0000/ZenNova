...
function strlen(e) {
    ...
    var r = function(e, t) {
        ...
        if (55296 <= a && a <= 56319) {
            ...
            if (56320 > (n = e.charCodeAt(t + 1)) || n > 57343) throw "High surrogate without following low surrogate";
...
function array_diff(e) {
    ...
    e: for (n in e)
        for (r = 1; r < a; r++) {
            for (i in s = arguments[r])
                if (s[i] === e[n]) continue e;
            t[n] = e[n]
        }
    return t
}
...
function strtotime(e, t) {
    ...
    if ((n = (e = e.replace(/^\s+|\s+$/g, "").replace(/\s{2,}/g, " ").replace(/[\t\r\n]/g, "").toLowerCase()).match(/^(\d{1,4})([\-\.\/\:])(\d{1,2})([\-\.\/\:])(\d{1,4})(?:\s(\d{1,2}):(\d{2})?:?(\d{2})?)?(?:\s([A-Z]+)?)?$/)) && n[2] === n[4])
        if (n[1] > 1901) switch (n[2]) {
            case "-":
            case "/":
                return n[3] > 12 || n[5] > 31 ? m : new Date(n[1], parseInt(n[3], 10) - 1, n[5], n[6] || 0, n[7] || 0, n[8] || 0, n[9] || 0) / 1e3;
            case ".":
                return m
        } else if (n[5] > 1901) switch (n[2]) {
            case "-":
            case ".":
                return n[3] > 12 || n[1] > 31 ? m : new Date(n[5], parseInt(n[3], 10) - 1, n[1], n[6] || 0, n[7] || 0, n[8] || 0, n[9] || 0) / 1e3;
            case "/":
                return n[1] > 12 || n[3] > 31 ? m : new Date(n[5], parseInt(n[1], 10) - 1, n[3], n[6] || 0, n[7] || 0, n[8] || 0, n[9] || 0) / 1e3
        } else switch (n[2]) {
            case "-":
                return n[3] > 12 || n[5] > 31 || n[1] < 70 && n[1] > 38 ? m : (i = n[1] >= 0 && n[1] <= 38 ? +n[1] + 2e3 : n[1], new Date(i, parseInt(n[3], 10) - 1, n[5], n[6] || 0, n[7] || 0, n[8] || 0, n[9] || 0) / 1e3);
            case ".":
                return n[5] >= 70 ? n[3] > 12 || n[1] > 31 ? m : new Date(n[5], parseInt(n[3], 10) - 1, n[1], n[6] || 0, n[7] || 0, n[8] || 0, n[9] || 0) / 1e3 : n[5] < 60 && !n[6] ? n[1] > 23 || n[3] > 59 ? m : (r = new Date, new Date(r.getFullYear(), r.getMonth(), r.getDate(), n[1] || 0, n[3] || 0, n[5] || 0, n[9] || 0) / 1e3) : m;
            case "/":
                return n[1] > 12 || n[3] > 31 || n[5] < 70 && n[5] > 38 ? m : (i = n[5] >= 0 && n[5] <= 38 ? +n[5] + 2e3 : n[5], new Date(i, parseInt(n[1], 10) - 1, n[3], n[6] || 0, n[7] || 0, n[8] || 0, n[9] || 0) / 1e3);
            case ":":
                return n[1] > 23 || n[3] > 59 || n[5] > 59 ? m : (r = new Date, new Date(r.getFullYear(), r.getMonth(), r.getDate(), n[1] || 0, n[3] || 0, n[5] || 0) / 1e3)
        }
    if ("now" === e) return null === t || isNaN(t) ? (new Date).getTime() / 1e3 | 0 : 0 | t;
    if (!isNaN(a = Date.parse(e))) return a / 1e3 | 0;
    if ((n = e.match(/^([0-9]{4}-[0-9]{2}-[0-9]{2})[ t]([0-9]{2}:[0-9]{2}:[0-9]{2}(\.[0-9]+)?)([\+-][0-9]{2}(:[0-9]{2})?|z)/)) && ("z" == n[4] ? n[4] = "Z" : n[4].match(/^([\+-][0-9]{2})$/) && (n[4] = n[4] + ":00"), !isNaN(a = Date.parse(n[1] + "T" + n[2] + n[4])))) return a / 1e3 | 0;
    ...
    function f(e) {
        ...
        if (r && (i *= parseInt(a, 10)), l.hasOwnProperty(n) && !t[1].match(/^mon(day|\.)?$/i)) return s["set" + l[n]](s["get" + l[n]]() + i);
        if ("wee" === n) return s.setDate(s.getDate() + 7 * i);
        if ("next" === a || "last" === a) ! function(e, t, a) {
            var n, r = o[t];
            void 0 !== r && (0 == (n = r - s.getDay()) ? n = 7 * a : n > 0 && "last" === e ? n -= 7 : n < 0 && "next" === e && (n += 7), s.setDate(s.getDate() + n))
        }(a, n, i);
        else if (!r) return !1;
        return !0
    }
    if (s = t ? new Date(1e3 * t) : new Date, o = {
            sun: 0,
            mon: 1,
            tue: 2,
            wed: 3,
            ...
            min: "Minutes",
            sec: "Seconds"
        }, h = "([+-]?\\d+\\s" + (d = "(years?|months?|weeks?|days?|hours?|minutes?|min|seconds?|sec|sunday|sun\\.?|monday|mon\\.?|tuesday|tue\\.?|wednesday|wed\\.?|thursday|thu\\.?|friday|fri\\.?|saturday|sat\\.?)") + "|(last|next)\\s" + d + ")(\\sago)?", !(n = e.match(new RegExp(h, "gi")))) return m;
...
! function(e) {
    ...
    e.extend(e.fn, {
        validate: function(t) {
            if (this.length) {
                ...
                return a || (this.attr("novalidate", "novalidate"), a = new e.validator(t, this[0]), e.data(this[0], "validator", a), a.settings.onsubmit && (this.on("click.validate", ":submit", (function(t) {
                    a.submitButton = t.target, e(this).hasClass("cancel") && (a.cancelSubmit = !0), void 0 !== e(this).attr("formnovalidate") && (a.cancelSubmit = !0)
                })), this.on("submit.validate", (function(t) {
                    function n() {
                        var n, r;
                        return a.submitButton && (n = e("<input type='hidden'/>").attr("name", a.submitButton.name).val(e(a.submitButton).val()).appendTo(a.currentForm)), !a.settings.submitHandler || (r = a.settings.submitHandler.call(a, a.currentForm, t), a.submitButton && n.remove(), void 0 !== r && r)
                    }
        ...
        rules: function(t, a) {
            var n, r, i, s, o, l, u = this[0];
            if (t) switch (r = (n = e.data(u.form, "validator").settings).rules, i = e.validator.staticRules(u), t) {
                case "add":
                    e.extend(i, e.validator.normalizeRule(a)), delete i.messages, r[u.name] = i, a.messages && (n.messages[u.name] = e.extend(n.messages[u.name], a.messages));
                    break;
                case "remove":
        ...
        defaults: {
            ...
            onkeyup: function(t, a) {
                9 === a.which && "" === this.elementValue(t) || -1 !== e.inArray(a.keyCode, [16, 17, 18, 20, 35, 36, 37, 38, 39, 40, 45, 144, 225]) || (t.name in this.submitted || t === this.lastElement) && this.element(t)
            },
            onclick: function(e) {
        ...
        prototype: {
            init: function() {
                ...
                })), t = this.settings.rules, e.each(t, (function(a, n) {
                    t[a] = e.validator.normalizeRule(n)
                })), e(this.currentForm).on("focusin.validate focusout.validate keyup.validate", ":text, [type='password'], [type='file'], select, textarea, [type='number'], [type='search'], [type='tel'], [type='url'], [type='email'], [type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'], [type='radio'], [type='checkbox']", n).on("click.validate", "select, option, [type='radio'], [type='checkbox']", n), this.settings.invalidHandler && e(this.currentForm).on("invalid-form.validate", this.settings.invalidHandler), e(this.currentForm).find("[required], [data-rule-required], .required:not(label)").attr("aria-required", "true")
            },
            form: function() {
            ...
            element: function(t) {
                var a = this.clean(t),
                    ...
                    r = !0;
                return this.lastElement = n, void 0 === n ? delete this.invalid[a.name] : (this.prepareElement(n), this.currentElements = e(n), (r = !1 !== this.check(n)) ? delete this.invalid[n.name] : this.invalid[n.name] = !0), e(t).attr("aria-invalid", !r), this.numberOfInvalids() || (this.toHide = this.toHide.add(this.containers)), this.showErrors(), r
            },
            showErrors: function(t) {
                if (t) {
                    for (var a in e.extend(this.errorMap, t), this.errorList = [], t) this.errorList.push({
                        message: t[a],
            ...
            elements: function() {
                ...
                return e(this.currentForm).find("input, select, textarea").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter((function() {
                    return !this.name && t.settings.debug && window.console && console.error("%o has no name assigned", this), !(this.name in a || !t.objectLength(e(this).rules())) && (a[this.name] = !0, !0)
                }))
            },
            clean: function(t) {
                return e(t)[0]
            ...
            elementValue: function(t) {
                var a, n = e(t),
                    r = t.type;
                return "radio" === r || "checkbox" === r ? this.findByName(t.name).filter(":checked").val() : "number" === r && void 0 !== t.validity ? !t.validity.badInput && n.val() : "string" == typeof(a = n.val()) ? a.replace(/\r/g, "") : a
            },
            check: function(t) {
                t = this.validationTargetFor(this.clean(t));
                var a, n, r, i = e(t).rules(),
                ...
                for (n in i) {
                    ...
                    try {
                        if ("dependency-mismatch" === (a = e.validator.methods[n].call(this, l, t, r.parameters)) && 1 === s) {
                            o = !0;
                            continue
                        }
            ...
            formatAndAdd: function(t, a) {
                var n = this.defaultMessage(t, a.method),
                    r = /\$?\{(\d+)\}/g;
                "function" == typeof n ? n = n.call(this, a.parameters, t) : r.test(n) && (n = e.validator.format(n.replace(r, "{$1}"), a.parameters)), this.errorList.push({
                    message: n,
                    element: t,
                    method: a.method
            ...
            showLabel: function(t, a) {
                var n, r, i, s = this.errorsFor(t),
                    o = this.idOrName(t),
                    l = e(t).attr("aria-describedby");
                s.length ? (s.removeClass(this.settings.validClass).addClass(this.settings.errorClass), s.html(a)) : (n = s = e("<" + this.settings.errorElement + ">").attr("id", o + "-error").addClass(this.settings.errorClass).html(a || ""), this.settings.wrapper && (n = s.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()), this.labelContainer.length ? this.labelContainer.append(n) : this.settings.errorPlacement ? this.settings.errorPlacement(n, e(t)) : n.insertAfter(t), s.is("label") ? s.attr("for", o) : 0 === s.parents("label[for='" + o + "']").length && (i = s.attr("id").replace(/(:|\.|\[|\]|\$)/g, "\\$1"), l ? l.match(new RegExp("\\b" + i + "\\b")) || (l += " " + i) : l = i, e(t).attr("aria-describedby", l), (r = this.groups[t.name]) && e.each(this.groups, (function(t, a) {
                    a === r && e("[name='" + t + "']", this.currentForm).attr("aria-describedby", s.attr("id"))
            ...
            stopRequest: function(t, a) {
                this.pendingRequest--, this.pendingRequest < 0 && (this.pendingRequest = 0), delete this.pending[t.name], a && 0 === this.pendingRequest && this.formSubmitted && this.form() && 0 === this.pendingRequest ? (e(this.currentForm).trigger("submit"), this.formSubmitted = !1) : !a && 0 === this.pendingRequest && this.formSubmitted && (e(this.currentForm).triggerHandler("invalid-form", [this]), this.formSubmitted = !1)
            },
        ...
        normalizeAttributeRule: function(e, t, a, n) {
            /min|max/.test(a) && (null === t || /number|range|text/.test(t)) && (n = Number(n), isNaN(n) && (n = void 0)), n || 0 === n ? e[a] = n : t === a && "range" !== t && (e[a] = !0)
        },
        attributeRules: function(t) {
            var a, n, r = {},
                i = e(t),
                s = t.getAttribute("type");
            for (a in e.validator.methods) "required" === a ? ("" === (n = t.getAttribute(a)) && (n = !0), n = !!n) : n = i.attr(a), this.normalizeAttributeRule(r, s, a, n);
        ...
        dataRules: function(t) {
            var a, n, r = {},
                i = e(t),
                s = t.getAttribute("type");
            for (a in e.validator.methods) n = i.data("rule" + a.charAt(0).toUpperCase() + a.substring(1).toLowerCase()), this.normalizeAttributeRule(r, s, a, n);
            return r
        },
        ...
        methods: {
            ...
            creditcard: function(e, t) {
                ...
                for (a = e.length - 1; a >= 0; a--) n = e.charAt(a), i = parseInt(n, 10), s && (i *= 2) > 9 && (i -= 9), r += i, s = !s;
                return r % 10 == 0
            },
            ...
            remote: function(t, a, n) {
                ...
                var r, i, s = this.previousValue(a);
                return this.settings.messages[a.name] || (this.settings.messages[a.name] = {}), s.originalMessage = this.settings.messages[a.name].remote, this.settings.messages[a.name].remote = s.message, n = "string" == typeof n && {
                    url: n
                } || n, s.old === t ? s.valid : (s.old = t, r = this, this.startRequest(a), (i = {})[a.name] = t, e.ajax(e.extend(!0, {
                    mode: "abort",
                    ...
                    success: function(n) {
                        var i, o, l, u = !0 === n || "true" === n;
                        r.settings.messages[a.name].remote = s.originalMessage, u ? (l = r.formSubmitted, r.prepareElement(a), r.formSubmitted = l, r.successList.push(a), delete r.invalid[a.name], r.showErrors()) : (i = {}, o = n || r.defaultMessage(a, "remote"), i[a.name] = s.message = e.isFunction(o) ? o(t) : o, r.invalid[a.name] = !0, r.showErrors(i)), s.valid = u, r.stopRequest(a, u)
                    }
                }, n)), "pending")
            }
        }
    ...
    e.ajaxPrefilter ? e.ajaxPrefilter((function(e, t, n) {
        ...
        return "abort" === r ? (a[i] && a[i].abort(), a[i] = t.apply(this, arguments), a[i]) : t.apply(this, arguments)
    })
})),
function(e, t) {
    ...
    return t = {
        ...
        merge: function(e) {
            ...
            for (e = e || {}, a = 1; a < arguments.length; a++)
                if (n = arguments[a])
                    for (var r in n) n.hasOwnProperty(r) && ("object" == typeof n[r] ? t.merge(e[r], n[r]) : e[r] = n[r]);
            return e
        },
        ...
        a.dateSettings = n.dateSettings, a.separators = n.separators, a.validParts = n.validParts, a.intParts = n.intParts, a.tzParts = n.tzParts, a.tzClip = n.tzClip
    }).prototype = {
        constructor: e,
        getMonth: function(e) {
            var a;
            return 0 === (a = t.getIndex(e, this.dateSettings.monthsShort) + 1) && (a = t.getIndex(e, this.dateSettings.months) + 1), a
        },
        parseDate: function(e, a) {
            var n, r, i, s, o, l, u, d, h, c, m = this,
                f = !1,
                g = !1,
                p = m.dateSettings,
                v = {
            ...
            for (r = e.replace(m.separators, "\0").split("\0"), i = 0; i < r.length; i++) switch (s = r[i], o = parseInt(s), n[i]) {
                case "y":
                case "Y":
                    if (!o) return null;
                    h = s.length, v.year = 2 === h ? parseInt((o < 70 ? "20" : "19") + s) : o, f = !0;
                    break;
                case "m":
                case "n":
                case "M":
                ...
                case "g":
                case "h":
                    if (c = r[u = n.indexOf("a") > -1 ? n.indexOf("a") : n.indexOf("A") > -1 ? n.indexOf("A") : -1], -1 !== u) d = t.compare(c, p.meridiem[0]) ? 0 : t.compare(c, p.meridiem[1]) ? 12 : -1, o >= 1 && o <= 12 && -1 !== d ? v.hour = o % 12 == 0 ? d : o + d : o >= 0 && o <= 23 && (v.hour = o);
                    else {
        ...
        guessDate: function(e, t) {
            ...
            var a, n, r, i, s, o, l = e.replace(this.separators, "\0").split("\0"),
                u = t.match(this.validParts),
                d = new Date,
                h = 0;
            if (!/^[djmn]/g.test(u[0])) return e;
            for (r = 0; r < l.length; r++) {
                if (h = 2, s = l[r], o = parseInt(s.substr(0, 2)), isNaN(o)) return null;
                switch (r) {
                    case 0:
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        if (n = d.getFullYear(), h = (a = s.length) < 4 ? a : 4, !(n = parseInt(a < 4 ? n.toString().substr(0, 4 - a) + s : s.substr(0, 4)))) return null;
                        d.setFullYear(n);
                        break;
                    case 3:
                        d.setHours(o);
            ...
            return n = {
                ...
                O: function() {
                    var e = a.getTimezoneOffset(),
                        n = Math.abs(e);
                    return (e > 0 ? "-" : "+") + t.lpad(100 * Math.floor(n / 60) + n % 60, 4)
                },
                P: function() {
                    var e = n.O();
        ...
        formatDate: function(e, t) {
            var a, n, r, i, s, o = this,
                l = "";
            if ("string" == typeof e && !(e = o.parseDate(e, t))) return null;
            if (e instanceof Date) {
                for (r = t.length, a = 0; a < r; a++) "S" !== (s = t.charAt(a)) && "\\" !== s && (a > 0 && "\\" === t.charAt(a - 1) ? l += s : (i = o.parseFormat(s, e), a !== r - 1 && o.intParts.test(s) && "S" === t.charAt(a + 1) && (n = parseInt(i) || 0, i += o.dateSettings.ordinal(n)), l += i));
                return l
            }
            return ""
        }
...
const laravelValidation = {
    ...
    arrayRules: function(e) {
        const t = {},
            ...
            n = a.arrayRulesCache;
        return -1 === e.name.indexOf("[") || (e.name in n || (n[e.name] = {}), $.each(a.settings.rules, (function(a, r) {
    ...
    setupValidations: function() {
        $.validator.addMethod("laravelValidation", (function(e, t, a) {
            ...
            return $.each(a, (function(e, t) {
                t[3] || -1 !== laravelValidation.implicitRules.indexOf(t[0]) ? s.unshift(t) : s.push(t)
            })), $.each(s, (function(a, s) {
                const o = s[3] || -1 !== laravelValidation.implicitRules.indexOf(s[0]),
                    l = s[0],
                    u = s[2];
                return !o && n.optional(t) ? (r = "dependency-mismatch", !1) : (r = void 0 !== laravelValidation.methods[l] && laravelValidation.methods[l].call(n, e, t, s[1], (function(a) {
                    if (n.settings.messages[t.name].laravelValidationRemote = i.originalMessage, a) {
                        const e = n.formSubmitted;
                        n.prepareElement(t), n.formSubmitted = e, n.successList.push(t), delete n.invalid[t.name], n.showErrors()
                    } else {
                        const a = {};
                        a[t.name] = i.message = $.isFunction(u) ? u(e) : u, n.invalid[t.name] = !0, n.showErrors(a)
                    }
                    n.showErrors(n.errorMap), i.valid = a
                })), !0 !== r ? (n.settings.messages[t.name] || (n.settings.messages[t.name] = {}), n.settings.messages[t.name].laravelValidation = u, !1) : void 0)
            })), r
            ...
            if ($.each(a, (function(e, t) {
                    s = s || t[3]
                })), !s && n.optional(t)) return "dependency-mismatch";
            n.settings.messages[t.name] || (n.settings.messages[t.name] = {}), r.originalMessage = n.settings.messages[t.name].laravelValidationRemote, n.settings.messages[t.name].laravelValidationRemote = r.message;
            var h = "string" == typeof h && {
                url: h
            } || h;
            if (laravelValidation.helpers.arrayEquals(r.old, e) || r.old === e) return r.valid;
            r.old = e, i = $(n.currentForm).serializeArray(), i.push({
                name: "_js_validation",
                value: l
            }), i.push({
            ...
            return n.startRequest(t), $.ajax($.extend(!0, {
                mode: "abort",
                ...
                beforeSend: function(e) {
                    if ("get" !== $(n.currentForm).attr("method").toLowerCase() && u) return e.setRequestHeader("X-XSRF-TOKEN", u)
                },
                complete: function() {
                    $(n.currentForm).find("button[type=submit]").prop("disabled", !1).removeClass("disabled")
                }
            }, h || {})).always((function(a, i) {
                let s, o, l, u;
                if ("error" === i) u = !1, a = laravelValidation.helpers.parseErrorResponse(a);
                else {
                    if ("success" !== i) return;
                    u = !0 === a || "true" === a
                }
                n.settings.messages[t.name].laravelValidationRemote = r.originalMessage, u ? (l = n.formSubmitted, n.prepareElement(t), n.formSubmitted = l, n.successList.push(t), delete n.invalid[t.name], n.showErrors()) : (s = {}, o = a || n.defaultMessage(t, "remote"), s[t.name] = r.message = $.isFunction(o) ? o(e) : o[0], n.invalid[t.name] = !0, n.showErrors(s)), n.showErrors(n.errorMap), r.valid = u, n.stopRequest(t, u)
            })), "pending"
        }), "")
    }
};
        ...
        helpers: {
            ...
            hasRules: function(e, t) {
                ...
                return e.name in i && $.each(i[e.name], (function(e, t) {
                    r.push(t)
                })), e.name in n.settings.rules && r.push(n.settings.rules[e.name]), $.each(r, (function(e, n) {
            ...
            getSize: function(e, t, a) {
                return this.hasNumericRules(t) && this.is_numeric(a) ? parseFloat(a) : $.isArray(a) ? parseFloat(a.length) : "file" === t.type ? parseFloat(Math.floor(this.fileinfo(t).size)) : parseFloat(this.strlen(a))
            },
            getLaravelValidation: function(e, t) {
                var a = void 0;
                return $.each($.validator.staticRules(t), (function(t, n) {
                    "laravelValidation" === t && $.each(n, (function(t, n) {
                        n[0] === e && (a = n)
                    }))
                })), a
            },
            parseTime: function(e, t) {
                ...
                return null == t ? a = this.strtotime(e) : (a = n.parseDate(e, t)) && (a = Math.round(a.getTime() / 1e3)), a
            },
            guessDate: function(e, t) {
            ...
            arrayEquals: function(e, t) {
                return !(!$.isArray(e) || !$.isArray(t)) && (e.length === t.length && $.isEmptyObject(this.arrayDiff(e, t)))
            },
            dependentElement: function(e, t, a) {
                var n = e.findByName(a);
                if (void 0 !== n[0] && e.settings.onfocusout) {
                    var r = "blur";
                    "SELECT" !== n[0].tagName && "OPTION" !== n[0].tagName && "checkbox" !== n[0].type && "radio" !== n[0].type || (r = "click");
                    var i = ".validate-laravelValidation";
                    n.off(i).off(r + i + "-" + t.name).on(r + i + "-" + t.name, (function() {
                        $(t).valid()
                    }))
                }
                return n[0]
        ...
        helpers: {
            isTimezone: function(e) {
                var t = {
                    ...
                    n = a[0].toLowerCase(),
                    r = "";
                return a[1] && (r = a[1].toLowerCase()), n in t && (0 === t[n].length || -1 !== t[n].indexOf(r))
            }
        }
    }), $.extend(!0, laravelValidation, {
        methods: {
            ...
            RequiredWith: function(e, t, a) {
                ...
                return $.each(a, (function(e, a) {
                    ...
                    r = r || void 0 !== s && $.validator.methods.required.call(n, i.elementValue(s), s, !0)
            ...
            RequiredIf: function(e, t, a) {
                ...
                if (void 0 !== n) {
                    ...
                    if (void 0 !== r) {
                        var i = a.slice(1);
                        if (-1 !== $.inArray(r, i)) return $.validator.methods.required.call(this, e, t, !0)
                    }
                }
                return !0
            },
            ...
            InArray: function(e, t, a) {
                ...
                for (var n = this.elements(), r = !1, i = laravelValidation.helpers.regexFromWildcard(a[0]), s = 0; s < n.length; s++) {
                    var o = n[s].name;
                    if (o.match(i)) {
            ...
            Array: function(e, t) {
                return -1 !== t.name.indexOf("[") && -1 !== t.name.indexOf("]") || $.isArray(e)
            },
            Boolean: function(e) {
